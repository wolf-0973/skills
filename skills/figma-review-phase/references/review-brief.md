...
<!-- SYNC: 与 figma-to-code/references/review-brief.md 保持一致，改一处同步另一处 -->
...
Review evidence is limited to this brief, the Figma reference, implementation screenshots, browser/runtime evidence, and code.
